...
<body>
    ...
    <br>
    <br>
    <input type="submit" name="ProcessBtn" value="Process">
    <br>
    <br>
    <?php
  ...
  <div>
  <img src="gon.jpg" style="width: <?php echo $ImageRangeSize . '%'; ?>;border-color: <?php echo $border; ?>;border-width: 4px; border-style: solid;">
  </div>
